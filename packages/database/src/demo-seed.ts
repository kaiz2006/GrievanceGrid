...
async function demoSeed(): Promise<void> {
  ...
  console.log("[demo-seed] DATABASE_URL loaded:", dbUrl ? "yes" : "no");
  if (dbUrl) {
    console.log("[demo-seed] target:", dbUrl.replace(/:[^:@/]+@/, ":***@"));
  }
  ...
  // Insert users
  console.log("[demo-seed] Inserting users...");
  const userRows = await db.insert(users).values([
    {
      ...
      role: "ADMIN",
      auth_type: "BASIC",
      password_hash: hashPasswordForSeed("admin1"),
    ...
    },
    {
      ...
      role: "CREW",
      auth_type: "BASIC",
      password_hash: hashPasswordForSeed("crew1"),
    ...
    },
    {
      ...
      role: "AUDITOR",
      auth_type: "BASIC",
      password_hash: hashPasswordForSeed("auditor1"),
      phone: "+91-98765-43217",
      is_active: true,
    },
    {
      ...
      role: "CITIZEN",
      auth_type: "BASIC",
      password_hash: hashPasswordForSeed("citizen1"),
    ...
    },
    {
      ...
      role: "CITIZEN",
      auth_type: "BASIC",
      password_hash: hashPasswordForSeed("citizen3"),
