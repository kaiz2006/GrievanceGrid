...
def train_model(data_dir: str, epochs: int = 10, batch_size: int = 32, learning_rate: float = 0.001):
    ...
    save_path = "/app/models/damage_classifier.pth"
...
if __name__ == "__main__":
    DATA_ROOT = os.getenv("CV_DATA_ROOT", "/app/data/images")
