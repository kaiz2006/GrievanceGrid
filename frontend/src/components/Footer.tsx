          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xl font-bold text-text-primary">
                Grievance<span className="text-accent-light">Grid</span>
              </span>
            </a>
            <p className="text-text-secondary text-sm leading-relaxed max-w-sm mb-6">
              Transforming public service delivery through intelligent
              grievance management. Built for governments that care.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href="#"
                  className="w-10 h-10 rounded-xl glass flex items-center justify-center text-text-muted hover:text-text-primary hover:bg-white/10 transition-all"
